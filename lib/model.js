...
class Model {
  ...
  *****************************************************************/
   ...
   */
  add (item = {}, params = {}) {
    return this.list.push(new this.constructor(item, params))
  }
   ...
   */
  hasMore () {
    return this.$modelize.count > this.list.length
  }
