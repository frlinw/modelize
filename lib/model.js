  ...
  *****************************************************************/
  ...
  constructor (data, options = {}) {
    ...
    if (isObject(data)) {
      ...
      this.$validator = Object.assign({}, this.constructor.validator)
  ...
  _mutateData (newData) {
    ...
    if (has(newData, '$count')) {
      ...
      if (!this.$resources.options.extend) {
    ...
    for (const fielditem of fieldlist) {
      ...
      if (isString(fielditem)) {
        ...
        if (has(this, fieldname)) {
          this.$validator[fieldname].toSend = true
  ...
  error (fieldname) {
    return (
      this.$validator[fieldname].toSend &&
