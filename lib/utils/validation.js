...
// Date
export const isDate = (value) => value instanceof Date && !isNaN(value.valueOf())
// Ref: https://github.com/moment/moment/blob/develop/src/lib/moment/constructor.js#L75
export const isMoment = (value) => value instanceof Moment || (value != null && value._isAMomentObject != null)
